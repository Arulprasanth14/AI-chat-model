...
When conducting the Carousel brief for a Retail client, the **Images & Assets** section covers the following key information.
...
Optionally, ask the client: Upload your files. (this is not required) Upload product photos, collection images, store photography, logos, or supporting assets.
